    ...
    <>
      ...
      {activeSection === 'dashboard' && (
        <div className="space-y-6">
          <DashboardStatsSection className="animate-in fade-in slide-in-from-bottom-5 duration-500 delay-150" />
          <div className="w-full max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {!isLoadingFriends && !friendsError && friends && friends.friends.length > 0 && (
                <Card className="md:col-span-1 animate-in fade-in slide-in-from-bottom-5 duration-500 delay-450" interactive>
                  <CardHeader className="pb-3">
                    <div className="flex items-center gap-3">
                      <div className="p-2 rounded-full bg-primary/10">
              ...
              {isLoadingFriends && (
                <Card className="md:col-span-1 animate-in fade-in slide-in-from-bottom-5 duration-500 delay-450">
                  <CardHeader className="pb-3">
                    <div className="flex items-center gap-3">
                      <div className="p-2 rounded-full bg-primary/10">
                        <Users className="h-4 w-4 text-primary" />
