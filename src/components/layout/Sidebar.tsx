    ...
    <div className="flex h-full max-h-screen flex-col">
      ...
      <div className="flex h-14 items-center border-b border-border px-4 lg:h-[60px] lg:px-6">
        <Link href="/" className="flex items-center gap-2 font-semibold text-foreground group">
          <div 
             className="flex items-center justify-center w-8 h-8 rounded-md bg-primary text-primary-foreground font-bold shadow-sm transition-all duration-200 group-hover:shadow group-hover:scale-105 overflow-hidden" 
